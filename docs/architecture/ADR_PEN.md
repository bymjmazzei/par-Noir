...
Time calendar widgets; Records register UI / query engine; **live poll vote / table tally write path**; MCP tool servers; **My fonts / cloud font grants**; engager weight refinements (repost-originated); Veriff product UX.
