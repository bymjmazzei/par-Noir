/* GENERATED from packages/pqc-crypto/src/oauthUnlockProofBrowser.ts by build:oauth-unlock-script. Do not edit by hand. */
"use strict";
(() => {
  ...
  var genCrystals = (opts) => {
    ...
    const dif = FFTCore(field, __spreadValues({ dit: false }, nttOpts));
    const dit = FFTCore(field, __spreadValues({ dit: true }, nttOpts));
    const NTT2 = {
      encode: (r) => {
        return dif(r);
      },
  ...
  var ml_dsa44 = /* @__PURE__ */ getDilithium(__spreadProps(__spreadValues({}, PARAMS[2]), {
    CRH_BYTES: 64,
    TR_BYTES: 64,
    C_TILDE_BYTES: 32,
    XOF128,
  ...
  var ml_dsa65 = /* @__PURE__ */ getDilithium(__spreadProps(__spreadValues({}, PARAMS[3]), {
    CRH_BYTES: 64,
    TR_BYTES: 64,
    C_TILDE_BYTES: 48,
    XOF128,
  ...
  var ml_dsa87 = /* @__PURE__ */ getDilithium(__spreadProps(__spreadValues({}, PARAMS[5]), {
    CRH_BYTES: 64,
    TR_BYTES: 64,
    C_TILDE_BYTES: 64,
    XOF128,
  ...
  // src/mlDsa.ts
  function mlDsa65Sign(message, secretKey) {
    return ml_dsa65.sign(message, secretKey);
  }

  // src/oauthUnlockProof.ts
  var OAUTH_UNLOCK_PROOF_VERSION = "PN-OAUTH-UNLOCK-V1";
  function normalizeRedirectUri(redirectUri) {
    return redirectUri.replace(/\/$/, "");
  }
  function buildOauthUnlockProofMessage(params) {
    const lines = [
  ...
  function extractMlDsaSecretKeyB64(decrypted) {
    ...
    const sk = ((_a = decrypted.pqcSecrets) == null ? void 0 : _a.mlDsaSecretKey) || decrypted.privateKey;
  ...
  globalThis.ParNoirOauthUnlockProof = api;
})();
