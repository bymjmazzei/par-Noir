...
export interface IdentityCoreEvents {
    ...
    'did_authenticated': (data: {
        didId: string;
        pnName: string;
    }) => void;
    'security:event': (securityEvent: any) => void;
    'webauthn_supported': (data: {
        supported: boolean;
    }) => void;
}
...
export declare const IdentityErrorCodes: {
    readonly DID_NOT_FOUND: "DID_NOT_FOUND";
    readonly INVALID_PASSCODE: "INVALID_PASSCODE";
    ...
    readonly PRIVACY_ERROR: "PRIVACY_ERROR";
