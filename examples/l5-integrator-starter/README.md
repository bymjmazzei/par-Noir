...
3. Copy `../../packages/oauth-ui/static/oauth-callback.html` to `public/oauth-callback.html`.
4. From repo root: `npm install`, then `cd examples/l5-integrator-starter && npm run dev`.
