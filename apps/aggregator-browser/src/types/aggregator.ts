...
export interface PublicMetadata {
  ...
  // Tag provenance and normalization
  geminiTags?: string[]; // Tags generated by Gemini AI (for provenance tracking)
  subjects?: string[]; // Extracted subjects
  normalizedTags?: Array<{
    id: string; // Normalized tag ID
    displayName: string;
  ...
  // Tag provenance (PROV-O compatible)
  // Tags can be linked to activities via prov:wasGeneratedBy
  // Each tag's provenance is stored in normalizedTags[].provenance
  // This allows tracking: prov:wasGeneratedBy -> Activity -> prov:wasAttributedTo -> Tag
