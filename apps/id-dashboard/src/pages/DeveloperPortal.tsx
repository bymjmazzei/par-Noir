        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="#" className="text-primary hover:text-accent font-medium">View API Docs →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="#" className="text-primary hover:text-accent font-medium">ZKP Guide →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="#" className="text-primary hover:text-accent font-medium">Recovery Guide →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="#" className="text-primary hover:text-accent font-medium">Auth Guide →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="https://github.com/identity-protocol/identity-sdk" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent font-medium">SDK Docs →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="#" className="text-primary hover:text-accent font-medium">Best Practices →</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-secondary rounded-lg shadow-lg overflow-hidden">
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  <a href="#" className="inline-flex items-center px-3 py-2 bg-primary hover:bg-hover text-bg-primary text-sm rounded-lg font-medium transition-colors">View Tutorial</a>
                  <a href="https://github.com/identity-protocol/examples/tree/main/age-verification" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-3 py-2 bg-secondary hover:bg-hover text-text-primary text-sm rounded-lg font-medium transition-colors">View Code</a>
                </div>
              </div>
            </div>
            <div className="bg-secondary rounded-lg shadow-lg overflow-hidden">
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  <a href="#" className="inline-flex items-center px-3 py-2 bg-primary hover:bg-hover text-bg-primary text-sm rounded-lg font-medium transition-colors">View Tutorial</a>
                  <a href="https://github.com/identity-protocol/examples/tree/main/mobile" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-3 py-2 bg-secondary hover:bg-hover text-text-primary text-sm rounded-lg font-medium transition-colors">View Code</a>
                </div>
              </div>
            </div>
            <div className="bg-secondary rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <a href="https://github.com/identity-protocol" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-4 py-2 bg-primary hover:bg-hover text-bg-primary rounded-lg font-medium transition-colors">View on GitHub</a>
            </div>
            <div className="text-center">
