        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="https://bymjmazzei.github.io/par-Noir/#oauth-endpoints" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent font-medium">View API Docs →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
            ...
            <div className="bg-bg-primary rounded-lg p-6">
              ...
              <a href="https://bymjmazzei.github.io/par-Noir/#privacy-auth" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent font-medium">Auth Guide →</a>
            </div>
            <div className="bg-bg-primary rounded-lg p-6">
