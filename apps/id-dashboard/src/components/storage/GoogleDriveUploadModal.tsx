...
// Handles file uploads to user's Google Drive with pN encryption
  ...
  const handleUpload = async () => {
    ...
    for (const file of selectedFiles) {
      const options: UploadOptions = {
        ...
        pinContent: true // Always permanent for Google Drive
      };
        ...
        <div className="bg-modal-bg rounded-lg shadow-xl w-full max-w-2xl p-6 relative">
          ...
          <div className="mb-6 p-4 rounded-lg border border-border">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-text-primary">Google Drive Storage</h3>
                  <p className="text-sm text-text-secondary">
                    {hasGoogleDriveConfig ? 'Connected to your Google Drive' : 'Not configured'}
                  </p>
                </div>
              </div>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              ...
              disabled={selectedFiles.length === 0 || uploading || !hasGoogleDriveConfig}
            >
