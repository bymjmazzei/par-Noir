...
export REACT_APP_VERIFF_API_KEY="${VERIFF_API_KEY:-your-veriff-api-key-here}"
export REACT_APP_VERIFF_API_SECRET="${VERIFF_API_SECRET:-your-veriff-api-secret-here}"
